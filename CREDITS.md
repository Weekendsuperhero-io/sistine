...
**Sistine** is maintained by **Weekend Superhero LLC** and stands on the shoulders of
...
Sistine is distributed under the MIT License (see [LICENSE](./LICENSE)), which preserves
the original Crenspire Technologies copyright alongside Weekend Superhero LLC. See
[NOTICE](./NOTICE) for the formal attribution notice.
