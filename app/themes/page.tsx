...
const presetThemes = [
  {
    // Neutral "pure glass" — the Sistine default: grey primary, transparent surfaces (the glass/canvas shows through).
    name: "Default",
    colors: defaultTheme,
    darkColors: {
  ...
  },
  {
    ...
    colors: {
      ...
      card: "oklch(0.97 0.01 255)",
      cardForeground: "oklch(0.2 0.03 265)",
      popover: "oklch(0.97 0.01 255)",
      popoverForeground: "oklch(0.2 0.03 265)",
      secondary: "oklch(0.92 0.02 255)",
      secondaryForeground: "oklch(0.2 0.03 265)",
      accent: "oklch(0.9 0.03 255)",
      accentForeground: "oklch(0.2 0.03 265)",
      ring: "oklch(0.5 0.12 255)",
    },
    darkColors: {
