...
import {
  ...
  InputOTPSeparator,
} from "@os-glass/components/ui/input-otp";
...
export const InputOTP = React.forwardRef<React.ElementRef<typeof BaseInputOTP>, InputOTPProps>(
  ({ className, variant = "glass", glow = false, ...props }, ref) => {
    return <BaseInputOTP ref={ref} variant={variant} className={cn(glow && "shadow-md shadow-purple-500/20", className)} {...props} />;
  },
);
...
export const InputOTPGroup = React.forwardRef<HTMLDivElement, InputOTPGroupProps>(({ className, variant = "glass", glow = false, ...props }, ref) => {
  return <BaseInputOTPGroup ref={ref} variant={variant} className={cn(glow && "shadow-md shadow-purple-500/20", className)} {...props} />;
});
...
export const InputOTPSlot = React.forwardRef<HTMLDivElement, InputOTPSlotProps>(({ className, variant = "glass", glow = false, ...props }, ref) => {
  return <BaseInputOTPSlot ref={ref} variant={variant} className={cn(glow && "ring-1 ring-purple-500/20", className)} {...props} />;
});
