...
const Toaster = ({ theme = "system", ...props }: ToasterProps) => {
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "group toast group-[.toaster]:rounded-xl group-[.toaster]:glass group-[.toaster]:glass-border group-[.toaster]:text-foreground",
          description: "group-[.toast]:text-muted-foreground",
          actionButton:
            "group-[.toast]:rounded-md group-[.toast]:glass group-[.toast]:glass-border group-[.toast]:text-foreground group-[.toast]:hover:opacity-90",
          cancelButton:
            "group-[.toast]:rounded-md group-[.toast]:glass group-[.toast]:glass-border group-[.toast]:text-muted-foreground group-[.toast]:hover:opacity-90",
          success:
