...
>(({ className, ...props }, ref) => (
  <ToggleGroupPrimitive.Item
    ...
    className={cn(
      ...
      "data-[state=on]:shadow-[0_1px_3px_oklch(0_0_0_/_0.1),inset_0_1px_1px_oklch(1_0_0_/_0.5)]",
      "dark:data-[state=on]:shadow-[0_2px_6px_oklch(0_0_0_/_0.4),inset_0_1px_2px_oklch(1_0_0_/_0.15),inset_0_0_8px_oklch(1_0_0_/_0.1)]",
