...
export const Vertical: Story = {
  render: () => (
    <ScrollArea className="h-72 w-48 rounded-md border glass backdrop-blur-[var(--blur)] border-[var(--glass-border)]">
      <div className="p-4">
...
export const Horizontal: Story = {
  render: () => (
    <ScrollArea className="w-96 whitespace-nowrap rounded-md border glass backdrop-blur-[var(--blur)] border-[var(--glass-border)]">
      <div className="flex w-max space-x-4 p-4">
        {Array.from({
          length: 20,
        }).map((_, i) => (
          <figure key={i} className="shrink-0">
            <div className="overflow-hidden rounded-md w-[150px] h-[150px] glass backdrop-blur-[var(--blur-sm)]">
  ...
  render: () => (
    <ScrollArea className="h-[400px] w-[350px] rounded-md border glass backdrop-blur-[var(--blur)] border-[var(--glass-border)] p-4">
      ...
      <div className="space-y-4 text-sm">
        <p>
          Sistine is a glassmorphic component library built on filtered light, with Next.js 16, React 19, and the shadcn-ui registry.
        </p>
