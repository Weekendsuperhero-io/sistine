...
export const WithActions: Story = {
  render: () => (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-sm text-muted-foreground mb-4">Toasts can include action buttons</p>
...
export const WithDuration: Story = {
  render: () => (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-sm text-muted-foreground mb-4">Control how long toasts are displayed</p>
...
export const WithPromise: Story = {
  render: () => (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-sm text-muted-foreground mb-4">Show loading, success, or error states automatically</p>
...
export const Positions: Story = {
  render: () => (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-sm text-muted-foreground mb-4">Position toasts in different areas of the screen</p>
